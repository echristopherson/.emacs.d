;; This is a modification of David Zhou's irblack color theme, in which I've set the default background to a dark gray instead of the original black. Thus it is similar to my ir-gray_EAC for Vim.
  ...
  (color-theme-install
   '(color-theme-ir-gray_EAC
     ((background-color . "#1C1C1C")
      ...
      (mouse-color . "#660000"))
     (default ((t (:background "#1C1C1C" :foreground "#F6F3E8"))))
     ...
     (linum ((t (:background "#000000" :foreground "#3D3D3D"))))
